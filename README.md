...
src/main/java/org/sid/accountservice/
├── dto/
│   ├── BankAccountRequestDTO.java      # Request DTO
│   └── BankAccountResponseDTO.java     # Response DTO
├── entities/
│   └── BankAccount.java                # JPA Entity
├── enums/
│   └── AccountType.java                # Account type enum
├── mappers/
│   └── AccountMapper.java              # Entity-DTO mapper
├── repositories/
│   └── BankAccountRepository.java      # Spring Data JPA repository
├── service/
│   ├── AccountService.java             # Service interface
│   └── AccountServiceImpl.java         # Service implementation
├── web/
│   ├── AccountRestController.java      # REST controller
│   └── BankAccountGraphQLController.java # GraphQL controller
└── Tp2MicroserviceApplication.java     # Main application
...
This repository contains a multi-service microservices sample used for learning and demonstration purposes. The system is composed of several Spring Boot microservices and supporting components demonstrating configuration, discovery, API gateway, and individual service responsibilities.

Services included

- `discovery-service` — Service registry (Eureka / discovery).
- `config-microservice` / `config-repo` — Centralized configuration server and repository files.
Bank Account Microservice
...
Author
Created by Naoufal Guendouz as part of TP2 Microservice assignmen
Author
